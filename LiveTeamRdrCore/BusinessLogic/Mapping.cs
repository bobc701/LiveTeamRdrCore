...
namespace LiveTeamRdrApi.BusinessLogic {
   ...
   public static class Mapping {
      ...
      public static List<ZBatting> ToZBatting(this List<Batting1_app_Result> listIn) {
      ...
      public static List<ZGamesByPosn> ToZGamesByPosn(this List<GamesByPosn1_app_Result> listIn) {
      ...
      public static List<ZPitching> ToZPitching(this List<Pitching1_app_Result> listIn) {
      ...
      public static List<ZFieldingYear> ToZFieldingYear(this List<FieldingYear1_app_Result> listIn) {
         // ---------------------------------------------------------------------
